...
def romscice_evap_era_monthly (roms_file, cice_file, month, colour_bounds=None, save=False, fig_name=None):
...
if __name__ == "__main__":
    ...
    if action == 's':
        ...
        save = False
        fig_name = None
    romscice_evap_era_monthly(roms_file, cice_file, month, colour_bounds, save, fig_name)
